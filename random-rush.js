(() => {
  const choices = [
    { mode: 'classic', title: 'Classic free play · 4×4 grid', sub: '2 minutes · free play' },
    { mode: 'minimum', title: 'Minimum 5 · 6×6 grid', sub: '3 minutes · long words only' },
    { mode: 'sudden', title: 'Sudden death · 5×5 grid', sub: '3 minutes · one miss ends it' },
    { mode: 'race', title: 'Race to 500 · 4×4 grid', sub: '4 minutes · first to 500 wins' }
  ];
  ...
  const launch = event => {
    ...
    if (window.wordrushSessionCode) document.querySelector('#multiplayerDialog').showModal();
...
const resultsScript=document.createElement('script');resultsScript.src='results.js';document.body.append(resultsScript);
